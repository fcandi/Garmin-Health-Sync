...
export const fr: Record<TranslationKeys, string> = {
	...
	settingsGarminSessionPrivacyDesc: "Les cookies de session sont stockés dans les données locales du plugin Obsidian pour restaurer la session ; traitez-les comme un jeton de connexion",
