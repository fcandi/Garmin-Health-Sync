export const en = {
	...
	settingsGarminSessionPrivacyDesc: "Session cookies are stored in local Obsidian plugin data so the session can be restored; treat them like a login token",
