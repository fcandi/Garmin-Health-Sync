...
export const de: Record<TranslationKeys, string> = {
	...
	settingsGarminSessionPrivacyDesc: "Session-Cookies werden lokal in den Obsidian-Plugin-Daten gespeichert, damit die Sitzung wiederhergestellt werden kann; behandle sie wie ein Login-Token",
